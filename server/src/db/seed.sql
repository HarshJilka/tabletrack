-- ============================================================
-- TableTrack — Full Setup (run this ONE file in pgAdmin)
-- It drops old tables, recreates them, then inserts demo data
-- ============================================================
...
INSERT INTO users (id, name, email, phone, password_hash, role, is_active, is_approved, joined_on) VALUES
  ('00000000-0000-0000-0000-000000000001','Restaurant Admin','admin@tabletrack.com','+91 90000 00000','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','admin',     true, true, '2026-01-01'),
  ('00000000-0000-0000-0000-000000000002','Raj Supervisor',  'raj@tabletrack.com',  '+91 98000 11111','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','supervisor',true, true, '2026-01-01'),
  ('00000000-0000-0000-0000-000000000003','Aarav Mehta',     'aarav@example.com',   '+91 98765 43210','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','customer',  true, true, '2026-01-12'),
  ('00000000-0000-0000-0000-000000000004','Priya Sharma',    'priya@example.com',   '+91 91234 56789','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','customer',  true, true, '2026-02-03'),
  ('00000000-0000-0000-0000-000000000005','Rohan Gupta',     'rohan@example.com',   '+91 99887 76655','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','customer',  true, true, '2026-03-20'),
  ('00000000-0000-0000-0000-000000000006','Sneha Verma',     'sneha@example.com',   '+91 90011 22334','$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LPVKGgv9981','customer',  true, false,'2026-06-18');
